...
struct qt_meta_stringdata_MyStyle_t {
    QByteArrayData data[1];
    char stringdata0[8];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_MyStyle_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MyStyle_t qt_meta_stringdata_MyStyle = {
    {
QT_MOC_LITERAL(0, 0, 7) // "MyStyle"
...
static const uint qt_meta_data_MyStyle[] = {
...
QT_INIT_METAOBJECT const QMetaObject MyStyle::staticMetaObject = { {
    &QProxyStyle::staticMetaObject,
    qt_meta_stringdata_MyStyle.data,
    qt_meta_data_MyStyle,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *MyStyle::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MyStyle.stringdata0))
